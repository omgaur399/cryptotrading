...
const VP_BUCKETS    = 100;
const VP_WIDTH_PCT  = 0.12;
const VP_OPACITY    = 0.82;
const VP_BUY_COLOR  = 'rgba(16, 185, 129, 0.55)';
const VP_SELL_COLOR = 'rgba(220, 38, 38, 0.55)';
const VP_POC_COLOR  = '#facc15';
