...
document.addEventListener("DOMContentLoaded", () => {
    ...
    ChartBuilderService.initialize({
        ...
        syncTimeScales, loadOlderHistoricalData: ChartDataService.History.loadOlder, addHorizontalLine, updateMarkers,
...
function renderGrid() {
    ...
    Object.values(state.charts).forEach(chartData => {
        ChartDataService.Live.unsubscribe(chartData);
    ...
    for (let index = 1; index <= state.chartCount; index += 1) {
        ...
        ChartDataService.History.loadInitial(chartData);
    }
...
function populatePaneControls(chartData) {
    ...
    intervalSelect.addEventListener("change", async () => {
        ...
        await ChartDataService.History.loadInitial(chartData);
...
function changeChartType(chartData) {
    ...
    ChartDataService.Render.syncCache(chartData);
...
function updateConnectionStatus() {
    ...
    if (isConnected && !wasConnected) {
        Object.values(state.charts).forEach(ChartDataService.Live.subscribe);
    }
}
